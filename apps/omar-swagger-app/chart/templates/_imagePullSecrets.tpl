...
*/}}
{{- define "omar-swagger.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-swagger.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-swagger.generateImagePullSecret" }}
