...
*/}}
{{- define "omar-swagger.serviceAccount.enabled" -}}
...
*/}}
{{- define "omar-swagger.serviceAccount.name" -}}
{{-   if eq (include "omar-swagger.serviceAccount.enabled" $) "true" }}
{{-     pluck "name" .Values.serviceAccount .Values.global.serviceAccount | first | default (include "omar-swagger.fullname" $) -}}
{{-   else }}
