{{- define "omar-swagger.imagePullSecret" }}
...
Common labels
*/}}
{{- define "omar-swagger.labels" -}}
omar-swagger.sh/chart: {{ include "omar-swagger.chart" . }}
{{ include "omar-swagger.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "omar-swagger.selectorLabels" -}}
app.kubernetes.io/name: {{ include "omar-swagger.name" . }}
...
{{- define "omar-swagger.pullPolicy" -}}
